...
--with-zlib=objs/lib/zlib-1.2.10 --with-select_module --with-http_realip_module \
...
--with-mail --with-stream --with-openssl=objs/lib/openssl-1.0.2j --with-openssl-opt=no-asm \
